...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The GetNextPerson method should check if the person turns is 0 or minor for the infinite turns case.
    //The GetNextPerson method should check if the person turns when turns higher than 0, to minor it by 1 and then check if the turns left is higher than 0 again to re-queue it to the list or not.
    ...
    // Defect(s) Found: all defects found on the previous test also apply to this one.
